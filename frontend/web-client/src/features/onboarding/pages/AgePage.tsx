...
function AgePage() {
    ...
    return (
        <div className="w-screen h-screen bg-white flex flex-col items-center justify-center relative overflow-hidden animate-fadeIn" onClick={() => isOpen && setIsOpen(false)}>
            {/* 뒤로 가기 버튼 */}
            <button
                onClick={() => navigate(-1)}
            ...
            <div className="flex flex-col items-center -mt-32">
                ...
                <div className="relative flex flex-col items-center">
                    ...
                    {isOpen && (
                        <div 
                            className="absolute top-12 left-0 w-[320px] bg-white border-2 border-[#FEAE02] rounded-lg shadow-lg z-10 overflow-hidden"
                        ...
                        >
                            {AGE_RANGES.map((ageRange, index) => (
                                <button
                                    ...
                                    className={`w-full h-[44px] px-4 flex items-center transition-colors ${
                                        selectedAge === ageRange.value 
                                            ? 'bg-[#FFF9E6]' 
                                            : 'hover:bg-[#FFF9E6]'
                                    } ${
                                        index !== AGE_RANGES.length - 1 ? 'border-b border-gray-100' : ''
                                    }`}
                                >
