...
# 새로 추가된 유틸리티 함수 임포트
from utils.llm_utils import get_openai_client as get_openai_client_for_llm
>>>>>>> 9c10104 (WIP: Main.py와 requirements.txt에 작업 중인 변경 사항 저장)
...
# 6-2) 프롬프트 라우터 연결 (새로 추가) -> 검토하려고 프린트 추가
print("Attempting to import routes.prompts...") # 추가
from routes.prompts import router as prompts_router
print("Prompts router imported successfully. Now including it.") # 추가
app.include_router(prompts_router, prefix="/api")
print("Prompts router included successfully.") # 추가
